...
import random
english_words =['morning', 'afternoon','book', 'ruler', 'pencil', 'rubber', 'eye', 'mouth',
...
english_2nd = ['frog', 'rabbit', 'bee', 'bird', 'sheep','hen', 'dog', 'cat','farm','family','rice', 'soup', 'egg', 'noodles',
               'nice', 'yummy']

if __name__ == '__main__':
    print(random.choices(english_words))
